...
public class Users {
    ...
    ////////////////////////// DROP TABLE //////////////////////////
    /** ps to delete table UserTable from the database */
    ...
    ////////////////////////// UPDATE GENDER //////////////////////////
    /** ps to replace the idea in UserTable for specified row with given value */
    ...
    ////////////////////////// SELECT ALL //////////////////////////
    /** ps to return all rows from UserTable */
    ...
    /**
     * safely performs mSelectAllUsers = mConnection.prepareStatement("SELECT *
     * FROM UserTable");
     * 
