...
public class Downvotes {
    ...
    ////////////////////////// DROP TABLE //////////////////////////
    /** ps to delete table downvotetable from the database */
    ...
    /**
     * Remove downvotetable from the database. If it does not exist, this will print
     * an error.
     */
    void dropTable() {
        if (mDropTable == null)
    ...
    ////////////////////////// INSERT //////////////////////////
    /**
     * ps to instert into downvotetable a new row with next auto-gen id and the two given
     * values
     */
    ...
    /**
     * safely performs mInsertDownvote = mConnection.prepareStatement("INSERT INTO
     * downvotetable VALUES (default, ?, ?)");
     * 
    ...
    ////////////////////////// DELETE DOWNVOTE //////////////////////////
    /** ps for deleting a row from downvotetable */
    ...
    /** ps to return all rows from downvotetable, but only the user_id and idea_id columns */
    ...
    /**
     * Query the database for a count of all unique downvotes by idea_id
     * 
    ...
    /**
     * Query the database for a count of all unique downvotes by idea_id and user_id to
     * check
     * 
    ...
    ////////////////////////// SELECT ALL //////////////////////////
    /** ps to return all rows from downvotetable */
